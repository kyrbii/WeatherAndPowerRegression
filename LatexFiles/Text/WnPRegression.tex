...
\section*{Daten sammeln - Korbi}
    Siehe Doku in den MD files. Woher die Daten runtergenommen? Wie waren diese Daten unterteilt? Einmal Wetter und einmal Strom! Auswahlverfahren bei den Wetterdaten, welche waren interessant für uns?
\section*{Aufbereitung}
    Kobi schreibt hier über ie Python scripts zum aufbereiten - siehe Doku in den MD files
\section*{Regressionanalyse mit Weka}
    This will be Kays part to write i think
\section*{Vergleich von Modellen}
